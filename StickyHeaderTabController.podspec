...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of StickyHeaderTabController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Benjamin Chrobot/StickyHeaderTabController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Benjamin Chrobot' => 'benjamin.chrobot@alum.mit.edu' }
  s.source           = { :git => 'https://github.com/Benjamin Chrobot/StickyHeaderTabController.git', :tag => s.version.to_s }
